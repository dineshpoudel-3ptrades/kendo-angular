...
{
    public abstract class EfCoreTemplateRepositoryBase : EfCoreRepository<abpDbContext, Template, Guid>
    {
        public EfCoreTemplateRepositoryBase(IDbContextProvider<abpDbContext> dbContextProvider)
        ...
        public virtual async Task<List<Template>> GetListAsync(
            string? filterText = null,
            string? name = null,
            int? numberMin = null,
            int? numberMax = null,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            query = query.OrderBy(string.IsNullOrWhiteSpace(sorting) ? TemplateConsts.GetDefaultSorting(false) : sorting);
        ...
        protected virtual IQueryable<Template> ApplyFilter(
