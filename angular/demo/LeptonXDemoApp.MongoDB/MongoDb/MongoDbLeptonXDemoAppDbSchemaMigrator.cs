...
{
    public class MongoDbLeptonXDemoAppDbSchemaMigrator : ILeptonXDemoAppDbSchemaMigrator , ITransientDependency
    {
        private readonly IServiceProvider _serviceProvider;

        public MongoDbLeptonXDemoAppDbSchemaMigrator(IServiceProvider serviceProvider)
        {
