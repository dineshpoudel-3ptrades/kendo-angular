...
{
    public class LeptonXDemoAppTenantDatabaseMigrationHandler :
        IDistributedEventHandler<TenantCreatedEto>,
        IDistributedEventHandler<TenantConnectionStringUpdatedEto>,
        IDistributedEventHandler<ApplyDatabaseMigrationsEto>,
        ITransientDependency
    {
        private readonly IEnumerable<ILeptonXDemoAppDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ICurrentTenant _currentTenant;
        private readonly IUnitOfWorkManager _unitOfWorkManager;
        private readonly IDataSeeder _dataSeeder;
        private readonly ITenantStore _tenantStore;
        private readonly ILogger<LeptonXDemoAppTenantDatabaseMigrationHandler> _logger;

        public LeptonXDemoAppTenantDatabaseMigrationHandler(
            IEnumerable<ILeptonXDemoAppDbSchemaMigrator> dbSchemaMigrators,
            ICurrentTenant currentTenant,
            IUnitOfWorkManager unitOfWorkManager,
            IDataSeeder dataSeeder,
            ITenantStore tenantStore,
            ILogger<LeptonXDemoAppTenantDatabaseMigrationHandler> logger)
        {
        ...
        public async Task HandleEventAsync(TenantCreatedEto eventData)
        {
            await MigrateAndSeedForTenantAsync(
                eventData.Id,
                eventData.Properties.GetOrDefault("AdminEmail") ?? LeptonXDemoAppConsts.AdminEmailDefaultValue,
                eventData.Properties.GetOrDefault("AdminPassword") ?? LeptonXDemoAppConsts.AdminPasswordDefaultValue
            );
        }
        ...
        public async Task HandleEventAsync(TenantConnectionStringUpdatedEto eventData)
        {
            ...
            await MigrateAndSeedForTenantAsync(
                eventData.Id,
                LeptonXDemoAppConsts.AdminEmailDefaultValue,
                LeptonXDemoAppConsts.AdminPasswordDefaultValue
            );
