...
{
    public class LeptonXDemoAppDatabaseCheck : IHealthCheck, ITransientDependency
    {
        protected readonly IIdentityRoleRepository IdentityRoleRepository;

        public LeptonXDemoAppDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
        {
